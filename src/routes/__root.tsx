...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Silence API — Enterprise OpenAI-compatible Gateway" },
      { name: "description", content: "Silence API is a production OpenAI-compatible gateway with encrypted providers, intelligent routing, real analytics and enterprise reliability." },
      { name: "author", content: "Silence" },
      { property: "og:title", content: "Silence API — Enterprise OpenAI-compatible Gateway" },
